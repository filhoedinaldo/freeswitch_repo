...
-- Update: Edinaldo Lima <edinaldo.lima@digivox.com.br>
-- Date Update: 09/05/2024
...
if destination_number and string.len(destination_number) > 12 then
  ...
  --unity.consoleLog("info", "========== UNITY - DESTINATION NUMBER "..destination_number);
    ...
    if (operadora ~=nil and operadora ~= "") then
        ...
        unity.consoleLog("info", "========== UNITY - DESTINATION NUMBER " ..destination_number.. " ->> " ..new_destination);  
